                      ...
                      <tbody>
                          @foreach( $item as $food)
                              <tr>
                                  ...
                                  <td>
                                  @if($food->f_image)
                                        <img src="{{ asset('food_image/' . $food->f_image) }}" alt="Food Image" style="border-radius: 0; width: 200px; height: auto;">
                                    @else
                                        No Image
                                    @endif
                                  </td>
                                  <td>{{$food->f_desc}}</td>
                                  <td>
                                  <a href="{{ url('update_menu', $food->id) }}">
                                        <button type="button" class="btn btn-inverse-success btn-sm">Update</button>
                                    </a>
                                    <a href="{{ url('food_table', $food->id) }}">
